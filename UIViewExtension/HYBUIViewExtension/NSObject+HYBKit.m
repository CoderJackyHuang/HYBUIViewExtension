...
+ (CGSize)sizeWithFontSize:(CGFloat)fontSize text:(NSString *)text {
  return [self sizeWithFont:kFontWithSize(fontSize) text:text maxWidth:CGFLOAT_MAX];
}

+ (CGSize)sizeWithBoldFontSize:(CGFloat)fontSize text:(NSString *)text {
  return [self sizeWithFont:kBoldFontWithSize(fontSize) text:text maxWidth:CGFLOAT_MAX];
}

+ (CGSize)sizeWithFontSize:(CGFloat)fontSize text:(NSString *)text maxWidth:(CGFloat)maxWidth {
  return [self sizeWithFont:kFontWithSize(fontSize) text:text maxWidth:maxWidth];
}
